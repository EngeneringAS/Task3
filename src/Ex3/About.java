...
public class About extends JDialog {
    ...
    private void initComponents() {
        ...
        copyrightTextArea.setBackground(new java.awt.Color(204, 255, 204));
        copyrightTextArea.setColumns(25);
        copyrightTextArea.setFont(new java.awt.Font("MV Boli", 0, 10)); // NOI18N
        copyrightTextArea.setForeground(new java.awt.Color(0, 0, 204));
        copyrightTextArea.setLineWrap(true);
        copyrightTextArea.setRows(10);
        copyrightTextArea.setTabSize(10);
        copyrightTextArea.setText("Assignment 3\n\nThis interface was made by students for task number 3.\nYou can update, delete and modify data.\n\nCopyright (c) 2018  EngeneringAS, Inc.");
        copyrightTextArea.setToolTipText("");
        ...
        copyrightTextArea.getAccessibleContext().setAccessibleName("About");
